...
const strings = {
  ...
  confirmExit: {
    kz: "Тесттен шығу керек пе? Жауаптар сақталады — сессияны осы аккаунттан жалғастыра аласыз.",
    ru: "Выйти из теста? Ответы сохранятся — сессию можно продолжить с этого аккаунта.",
  },
  ...
  of: { kz: "дан", ru: "из" },
  heroTitle: {
    kz: "Талапкер — ҰБТ пробный тест",
    ru: "Талапкер — пробное тестирование ЕНТ",
  },
  heroSubtitle: {
